...
-- 1. ќпредел€ем критерии дл€ каждой буквы R, F, M (т.е. к примеру, R Ц 3 дл€ клиентов, которые покупали <= 30 дней от последней даты в базе, 
-- R Ц 2 дл€ клиентов, которые покупали > 30 и менее 60 дней от последней даты в базе и т.д.)
-- 2. ƒл€ каждого пользовател€ получаем набор из 3 цифр (от 111 до 333, где 333 Ц самые классные пользователи)
...
-- 3. ¬водим группировку, к примеру, 333 и 233 Ц это Vip, 1XX Ц это Lost, остальные Regular ( можете ввести боле глубокую сегментацию)
-- 4. ƒл€ каждой группы из п. 3 находим кол-во пользователей, кот. попали в них и % товарооборота, которое они сделали на эти 2 года.
...
-- 5. ѕровер€ем, что общее кол-во пользователей бьетс€ с суммой кол-во пользователей по группам из п. 3 
-- (если у вас есть логические ошибки в создании групп, у вас не собьютс€ цифры). “о же самое делаем и по деньгам.
...
--  ќЋ»„≈—“¬ќ ѕќЋ№«ќ¬ј“≈Ћ≈… —’ќƒ»“—я, ќЅў»… ƒќ’ќƒ Ќ≈ —’ќƒ»“—я
-- ¬ „®ћ ќЎ»Ѕ ј - Ќ≈ ¬»∆”
